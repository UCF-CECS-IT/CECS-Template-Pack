...
<!--
Thank you for reporting a possible bug in CECS-Template-Pack.
...
The version of this plugin can be found by clicking "Plugins" in the Admin navigation and finding "CECS Template Pack" in the list of plugins. The version number will be listed under the plugin description.
-->
